def dataCollect():
    ...
    on 28 December 1937.[10] He was the son of Naval Tata (who was born in Surat and later adopted into the Tata family), 
    ...
    Navajbai Tata, his grandmother and widow of Ratanji Tata.[11] He had a younger brother Jimmy Tata[12] and a half-brother, Noel 
    ...
    [13][14][15] After high school, Tata enrolled in Cornell University, from which he graduated with a bachelor's degree in 
    architecture in 1962.[16][17] While at Cornell, Tata became a member of the Alpha Sigma Phi Fraternity. In 2008, Tata gifted 
    Cornell $50 million, becoming the largest international donor in the university's history.[18][19]
    """
    return texts